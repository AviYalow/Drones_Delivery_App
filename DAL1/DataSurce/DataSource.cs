...
namespace DalObject
{
    internal class DataSource
    {
        ...
        public static void Initialize()
        {
            ...
            Client client3 = new Client { Id = (uint)rand.Next(100000000, 999999999), Latitude = 31.796158578989683, Longitude = 34.66586515449866, Name = (personalRandomName(rand, rand.Next(3, 7))), PhoneNumber = $"05{rand.Next(0, 6)}-{rand.Next(100, 999)}-{rand.Next(1000, 9999)}" };
            Client client4 = new Client { Id = (uint)rand.Next(100000000, 999999999), Latitude = 31.820190873604652, Longitude = 34.72233764519624, Name = (personalRandomName(rand, rand.Next(3, 7))), PhoneNumber = $"05{rand.Next(0, 6)}-{rand.Next(100, 999)}-{rand.Next(1000, 9999)}" };
            Client client5 = new Client { Id = (uint)rand.Next(100000000, 999999999), Latitude = 31.95219391037637, Longitude = 34.770318188724346, Name = (personalRandomName(rand, rand.Next(3, 7))), PhoneNumber = $"05{rand.Next(0, 6)}-{rand.Next(100, 999)}-{rand.Next(1000, 9999)}" };
            Client client6 = new Client { Id = (uint)rand.Next(100000000, 999999999), Latitude = 32.05327808523327, Longitude = 34.75681810343021, Name = (personalRandomName(rand, rand.Next(3, 7))), PhoneNumber = $"05{rand.Next(0, 6)}-{rand.Next(100, 999)}-{rand.Next(1000, 9999)}" };
            Client client7 = new Client { Id = (uint)rand.Next(100000000, 999999999), Latitude = 31.94281576785756, Longitude = 34.8245042988593, Name = (personalRandomName(rand, rand.Next(3, 7))), PhoneNumber = $"05{rand.Next(0, 6)}-{rand.Next(100, 999)}-{rand.Next(1000, 9999)}" };
            Client client8 = new Client { Id = (uint)rand.Next(100000000, 999999999), Latitude = 31.866628498784383, Longitude = 34.73603504157726, Name = (personalRandomName(rand, rand.Next(3, 7))), PhoneNumber = $"05{rand.Next(0, 6)}-{rand.Next(100, 999)}-{rand.Next(1000, 9999)}" };
            Client client9 = new Client { Id = (uint)rand.Next(100000000, 999999999), Latitude = 31.926210074685223, Longitude = 34.71376824495921, Name = (personalRandomName(rand, rand.Next(3, 7))), PhoneNumber = $"05{rand.Next(0, 6)}-{rand.Next(100, 999)}-{rand.Next(1000, 9999)}" };
            Client client10 = new Client { Id = (uint)rand.Next(100000000, 999999999), Latitude = 31.905193040785168, Longitude = 34.8050634373223, Name = (personalRandomName(rand, rand.Next(3, 7))), PhoneNumber = $"05{rand.Next(0, 6)}-{rand.Next(100, 999)}-{rand.Next(1000, 9999)}" };
